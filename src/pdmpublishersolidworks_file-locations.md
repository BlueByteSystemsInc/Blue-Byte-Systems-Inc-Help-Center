...
![File Locations settings](/images/pdmpublisher/solidworks/settings-file-locations-20260908.png)
...
PDMPublisher searches the active model's folder first, then the configured folders in list order. Keep the list narrow and place the most likely locations first.
