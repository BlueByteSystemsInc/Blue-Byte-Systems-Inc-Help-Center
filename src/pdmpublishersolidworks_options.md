...
The PDMPublisher tab contains the output and processing settings stored in the selected [profile](pdmpublishersolidworks_profiles.md).

![PDMPublisher for SOLIDWORKS Options page](/images/pdmpublisher/solidworks/overview-20260808.png)

Use the focused pages beneath **Options Tab** in the TOC:
