---
title: Annotation Text | PDMPublisher Annotations
description: Enter text or variables for a PDMPublisher annotation.
ms.date: 08/09/2026
ms.topic: reference
---
...
Enter the text that should appear on the exported PDF.
