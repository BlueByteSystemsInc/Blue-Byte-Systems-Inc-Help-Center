---
title: Server-Synced Activity Logs | PDMPublisher Options
description: Send PDMPublisher activity logs to the server for support review.
ms.date: 08/09/2026
ms.topic: reference
---
...
![Server synced activity logs setting](/images/pdmpublisher/screenshots/options-025-property-server-synced-activity-logs.png)
