---
title: Table Columns | PDMPublisher Options
description: Configure columns for the generated PDF table of contents.
ms.date: 08/09/2026
ms.topic: reference
---
...
- `Just Name` includes only the file or item name.
