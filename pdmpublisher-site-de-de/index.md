...
<a class="pdp-action pdp-action-solidworks" href="../src-de-de/pdmpublishersolidworks.md">PDMPublisher für SOLIDWORKS Add-in &rarr;</a>
</div>
<div class="pdp-actions">
<a class="pdp-action" href="src/welcome.md">Welcome to PDMPublisher</a>
<a class="pdp-action pdp-action-primary" href="../src-de-de/propertiespagepdmpublisher.md">Setzen Sie Ihre erste Aufgabe</a>
<a class="pdp-action" href="../src-de-de/pdmpublishertrial.md">Erhalten Sie eine 7-tägige PDM-Task-Testversion</a>
</div>
</section>
